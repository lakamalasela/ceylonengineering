...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="<?=base_url().'assest/css/plancard.css'?>">
            ...
            <div class="banner_inner d-flex align-items-center">
				...
				<div class="container">
					<div class="banner_content text-center">
                        <h2>CONTACT US</h2>
                        <img class="img img-responsive ceylon lk-ceylon" style="width:100%;padding:20px;margin:10px;" src="<?=base_url()?>assest/img/cy1.jpg" alt="">
						<!-- <div class="page_link">
...
<div class="container-fluid">
  ...
  <div class="title h1 text-center">CEYLON ENGINEERING Basic Construction Quotations</div>
  <!-- Card Start -->
  <div class="card data-aos="fade-right"">
    <div class="row ">

      <div id="lk-card" class="col-md-7 px-3">
...
<div id="lk-mycard" class="container" data-aos="zoom-in-up" data-aos-duration="500">
  <div class="row">
      <div class="col-md-12">
...
<br>
        ...
        <!--================Footer Area =================-->
        <footer id="lk-footer" class="footer_area p_120">
        	<div class="container">
